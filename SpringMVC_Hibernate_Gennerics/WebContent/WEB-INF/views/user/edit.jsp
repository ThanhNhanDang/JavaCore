    ...
    <div class="container">
        <div class="row mt-4">
            <div class="col-5 m-auto">
                ...
                <form action="<%=request.getContextPath()%>/<%=URL.INDEX_USER %>/<%=URL.EDIT_USER %>"	 method="POST">
                <div class="form-group">
                    ...
                    <a href="<%=request.getContextPath()%>/<%=URL.INDEX_USER %>" class="btn btn-secondary">Quay lại</a>
                </form>
            </div>
        </div>
    </div>
